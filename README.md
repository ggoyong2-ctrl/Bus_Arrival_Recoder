...
3. 공동배차 확인용 노선정보 엑셀파일
   -> 서울시버스노선기본정보(yyyymmdd).xlsx (자동 다운로드 및 저장)
...
2. 아래 페이지에 각각 접속하여 API사용신청하면, 인증키가 발급됩니다. 
...
동봉해드린 파이썬 코드를 참고해서 본인만의 프로그램을 신규 작성하신분의 경우, 본인의 프로그램을 활용신청하시면 각각의 API호출명 당 일일 트래픽 10000건으로 상향됩니다. (10000건이면 개인 수준에서 필요한 정보를 수집하기에 적당한 수준임)

5. API호출 트래픽이 부족할 때, API트래픽 상향을 위한 활용사례 신청 방법
